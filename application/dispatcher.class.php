...
class Dispatcher {
    ...
    public static function dispatch() {
        ...
        //get controller name or assign the default controller "FrontPageController"
        $controllerName = !empty($url_array[0]) ? ucfirst($url_array[0]) . 'Controller' : 'FrontPageController';
